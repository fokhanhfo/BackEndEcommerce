...
public class ProductRepositoryCustomImpl implements ProductRepositoryCustom{
    ...
    @Override
    public Page<Product> findProductsByCriteria(Long categoryId, BigDecimal priceGte, BigDecimal priceLte, String sort, List<String> searchKeywords, Pageable pageable) {
